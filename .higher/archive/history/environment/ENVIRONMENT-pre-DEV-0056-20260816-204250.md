...
（v019 后真实结构，Source: src-tauri/src/migrations/**）
...
| schema_migrations | version(PK) | name*, executed_at* | 19 行 |
| **goals.goal_brief_json(v019)** | — | TEXT NULL | Final Goal Canonical Brief 七字段 JSON（title/outcome/deadline/success_criteria[]/scope[]/constraints[]/unresolved[]）；仅 final 行使用 |
