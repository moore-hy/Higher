...
import { changedKinds, createSyncRefreshDispatcher, shouldRefresh, } from "../../src/sync/syncRefresh.js";
...
test("changedKinds 覆盖四类实体且互不串扰", () => {
    ...
    assert.deepEqual(changedKinds(payload({ profiles_changed: 1, goals_changed: 1, learning_items_changed: 1, tasks_changed: 1 })), ["profiles", "goals", "learningItems", "tasks"]);
});
